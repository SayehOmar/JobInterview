...
const BASE_META: Record<
  BaseLayerKey,
  { label: string; icon: typeof Satellite }
> = {
          ...
          {gearOpen && (
            <div className="animate-gear-open flex flex-row items-center justify-center gap-2">
              ...
              {hasPolygonOnMap && (
                <>
                  ...
                  >
                    <Pentagon
                      size={18}
                      className="text-[#0b4a59]"
                      strokeWidth={2}
                    />
                  </CircleTool>
                  <CircleTool
                    title="Delete drawing"
                    onClick={() => onDrawDelete()}
                  >
                    <Trash2
                      size={18}
              ...
              {(Object.keys(BASE_META) as BaseLayerKey[]).map((key) => {
                ...
                return (
                  ...
                  >
                    <Icon
                      size={18}
                      className={active ? "text-[#0b4a59]" : "text-gray-700"}
                      strokeWidth={2}
                    />
                  </CircleTool>
                );
              ...
              >
                <Layers
                  size={18}
                  className={showCadastre ? "text-[#0b4a59]" : "text-gray-700"}
                  strokeWidth={2}
                />
              </CircleTool>
            </div>
